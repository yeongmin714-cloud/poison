...
namespace ProjectName.Tests.EditMode
{
    ...
    public class Phase31_RingDifficultyDataTests
    {
        ...
        // ========================================================
        // 13. GetMonsterCountRange (링당 총 마리수: 배치 반경 확대에 따라 10배 상향)
        //     밤 ×2.0 배수는 MonsterSpawner가 별도 적용하므로 낮 기준 원값 검증
        // ========================================================

        [Test]
        public void GetMonsterCountRange_Ring1_Returns110()
        {
            Assert.AreEqual(new Vector2Int(110, 110), RingDifficultyData.GetMonsterCountRange(TerritoryDifficulty.Ring1));
        }

        [Test]
        public void GetMonsterCountRange_Ring2_Returns120()
        {
            Assert.AreEqual(new Vector2Int(120, 120), RingDifficultyData.GetMonsterCountRange(TerritoryDifficulty.Ring2));
        }

        [Test]
        public void GetMonsterCountRange_Ring3_Returns60()
        {
            Assert.AreEqual(new Vector2Int(60, 60), RingDifficultyData.GetMonsterCountRange(TerritoryDifficulty.Ring3));
        }

        [Test]
        public void GetMonsterCountRange_Ring4_Returns20()
        {
            Assert.AreEqual(new Vector2Int(20, 20), RingDifficultyData.GetMonsterCountRange(TerritoryDifficulty.Ring4));
        }

        [Test]
        public void GetMonsterCountRange_Empire_Returns20to40()
        {
            Assert.AreEqual(new Vector2Int(20, 40), RingDifficultyData.GetMonsterCountRange(TerritoryDifficulty.Empire));
        }
