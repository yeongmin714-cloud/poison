    ...
    public class RepairStationUI : UIWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (!string.IsNullOrEmpty(_statusMessage))
            {
                ...
                GUILayout.Box(_statusMessage, msgStyle, GUILayout.Height(36));
                GUILayout.Space(4);
            }
            else
            {
                GUILayout.Box("파손된 장비를 선택하여 수리하세요.", GUILayout.Height(28));
                GUILayout.Space(2);
            }
        ...
        {
            GUILayout.BeginHorizontal(_itemRowStyle, GUILayout.Height(44));
            ...
            GUILayout.Label(itemInfo, GUILayout.Width(240), GUILayout.Height(40));

            GUILayout.FlexibleSpace();

            // ── 수리비 ──
            GUILayout.Label($"💰 {entry.repairCost}G", GUILayout.Width(60), GUILayout.Height(40));
            ...
            if (GUILayout.Button(btnLabel, GUILayout.Width(70), GUILayout.Height(32)))
            {
