...
namespace ProjectName.UI
{
    ...
    public class GblItemIconRenderer : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, string> _itemToModel = new Dictionary<string, string>
        {
            ...
            { "boots_wood",     "wood_boot" },   // [TEST28-69차] 좌우 분리 → 통합 아이템
            { "boots_steel",    "steel_boot" },
            { "boots_stone",    "stone_boot" },
            { "boots_crystal",  "crystal_boot" },
            { "gloves_wood",    "wood_glove" },
            { "gloves_steel",   "steel_glove" },
            { "gloves_stone",   "stone_glove" },
            { "gloves_crystal", "crystal_glove" },
