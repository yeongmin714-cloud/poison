...
namespace ProjectName.UI
{
    ...
    public class PlayerFlagRegistrationWindow : UIWindow
    {
        ...
        private void OnGUI()
        {
            ...
            _editName = GUILayout.TextField(_editName, 8, GUILayout.Height(28), GUILayout.Width(_windowWidth - 40));
            ...
            _scrollPos = GUILayout.BeginScrollView(_scrollPos, GUILayout.Height(56));
            ...
            {
                GUILayout.Space(4);
                GUILayout.Box(_message, _messageStyle, GUILayout.Height(32));
            }
            ...
            if (GUILayout.Button("완료", GUILayout.Width(140), GUILayout.Height(40)))
            {
                OnConfirm();
            }
            GUI.enabled = true;
