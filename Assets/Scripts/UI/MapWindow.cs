...
namespace ProjectName.UI
{
    ...
    public class MapWindow : UIWindow
    {
        ...
        [Header("Map Layout")]
        [SerializeField] private float _windowPadding = 10f;
        [SerializeField] private float _regionCardWidth = 140f;
        [SerializeField] private float _regionCardHeight = 100f;
        [SerializeField] private float _territoryCellWidth = 130f;
        [SerializeField] private float _territoryCellHeight = 55f;
        ...
        private void OnGUI()
        {
            ...
            // Title
            Rect titleRect = new Rect(innerRect.x, innerRect.y, innerRect.width, 40f);
            ...
            DrawControls(new Rect(windowRect.x + _windowPadding, controlsY, windowRect.width - _windowPadding * 2, 30f));
        }
        ...
        private void DrawOverview(Rect area)
        {
            ...
            string backLabel = "[ ← 뒤로 ] ";
            Rect backRect = new Rect(area.x, area.y + area.height - 25f, 100f, 22f);
        ...
        private void DrawNationDetail(Rect area)
        {
            ...
            Rect headerRect = new Rect(area.x, area.y, area.width, 30f);
        ...
        private void DrawTerritoryCell(Rect rect, TerritoryDefinition def)
        {
            ...
            if (showFlag)
            {
                ...
                Rect flagColorRect = new Rect(cellInnerX, flagY, 16f, 12f);
        ...
        private void DrawControls(Rect area)
        {
            ...
            Rect posRect = new Rect(area.x + area.width - 250f, area.y, 250f, btnHeight);
