...
namespace ProjectName.Systems
{
    ...
    public class EquipmentStatBonusApplier : MonoBehaviour
    {
        ...
        private static readonly Dictionary<string, Bonus> _table = new Dictionary<string, Bonus>
        {
            ...
            // [TEST28-69차] 부츠/장갑 통합 아이템 — 방어력은 양발/양손 착용 기준(기존 좌+우 합산 상당)
            { "wood_boot",     new Bonus { defense = 8f,  speed = 0.2f } },
            { "steel_boot",    new Bonus { defense = 14f, speed = 0.2f } },
            { "stone_boot",    new Bonus { defense = 22f, speed = 0.2f } },
            { "crystal_boot",  new Bonus { defense = 32f, speed = 0.2f } },
            { "wood_glove",     new Bonus { defense = 6f  } },
            { "steel_glove",    new Bonus { defense = 10f } },
            { "stone_glove",    new Bonus { defense = 16f } },
            { "crystal_glove",  new Bonus { defense = 24f } },   // [TEST28-69차] 좌우 합산
