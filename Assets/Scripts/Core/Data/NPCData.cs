...
namespace ProjectName.Core.Data
{
    ...
    public static class NPCData
    {
        ...
        public static readonly string[] NamePool_Child =
        {
            "똘똘이", "꼬마", "아이돌", "별이", "꿈나무",
        ...
        public static readonly string[] NamePool_Adult =
        {
            "청년", "농부", "상인", "대장장이", "목수",
            "사냥꾼", "어부", "주정뱅이", "현자", "여행자",
        ...
        public static readonly string[] NamePool_Elderly =
        {
            "노인", "할아버지", "현자", "원로", "장로",
        ...
        public static readonly string[] Greetings_Child =
        {
            "안녕!", "놀아줘!", "심심해...", "뭐하고 있어?", "나랑 게임하자!",
            "오늘 날씨 좋지?", "배고파...", "엄마가 심부름 시켰어!", "재밌는 얘기 해줘!"
        };

        public static readonly string[] Greetings_Adult =
        {
        ...
        public static readonly string[] Greetings_Elderly =
        {
        ...
        public static readonly string[] QuestOffer_Child =
        {
            "이거 좀 도와줄 수 있어?", "내가 심부름을 맡았는데... 같이 할래?",
            "도움이 필요해!", "내가 재미있는 걸 발견했어!"
        };

        public static readonly string[] QuestOffer_Adult =
        {
            "일감이 하나 있는데, 들어보겠나?", "조금 부탁이 있습니다.",
            "보수는 넉넉히 드리겠소.", "일손이 필요해서 말이오."
        };

        public static readonly string[] QuestOffer_Elderly =
        {
